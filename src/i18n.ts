...
const en: TranslationMap = {
  ...
  weather: "Weather",
  uvTrend: "UV trend",
  dailyUvPlan: "Next 24 hours",
  peakUv: "Peak UV",
  peakTime: "Peak time",
  protectionWindow: "Protect from",
  allDayLow: "UV stays low",
  protectionPlan: "Protection plan",
  protectionCheckLater: "UV forecast is unavailable. Check again before going outside.",
  protectionLow: "UV is forecast to stay low; keep checking if you will be outside for a long time.",
  protectionSunscreen: "Use broad-spectrum SPF 30+ on exposed skin.",
  protectionShade: "Use shade when UV is strongest.",
  protectionEyes: "Wear sunglasses that block UV.",
  protectionClothing: "Add a hat and covering clothing where practical.",
  protectionAvoidPeak: "Limit direct sun around the peak UV time.",
  protectionWater: "Use water-resistant sunscreen and reapply after swimming or heavy sweating.",
  protectionSensitive: "Your sensitivity setting calls for extra care and shorter direct exposure.",
  now: "Now",
  next: "Next action",
  reason: "Reason",
  ...
  invalidLocationData: "Location data looked invalid. Try another city or refresh.",
...
const zh: TranslationMap = {
  ...
  weather: "天气",
  uvTrend: "今日 UV 趋势",
  dailyUvPlan: "未来 24 小时",
  peakUv: "峰值 UV",
  peakTime: "峰值时刻",
  protectionWindow: "重点防护时段",
  allDayLow: "UV 持续较低",
  protectionPlan: "个人防护清单",
  protectionCheckLater: "暂时没有 UV 预报，外出前请再次检查。",
  protectionLow: "预计 UV 持续较低；若长时间在室外，仍建议留意变化。",
  protectionSunscreen: "暴露部位使用广谱 SPF 30+ 防晒霜。",
  protectionShade: "UV 较强时优先利用阴凉处。",
  protectionEyes: "佩戴可阻挡紫外线的太阳镜。",
  protectionClothing: "条件允许时增加遮阳帽和覆盖性衣物。",
  protectionAvoidPeak: "峰值 UV 时段尽量减少阳光直晒。",
  protectionWater: "使用防水型防晒霜，并在游泳或大量出汗后补涂。",
  protectionSensitive: "你设置为容易晒伤，建议更谨慎并缩短阳光直晒时间。",
  now: "当前",
  next: "下一步",
  reason: "原因",
  reapplyAt: "{time} 补涂",
  ...
  invalidLocationData: "位置数据无效。请换一个城市或刷新重试。",
