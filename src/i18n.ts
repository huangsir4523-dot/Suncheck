...
const en: TranslationMap = {
  ...
  unsure: "Not sure",
  attribution: "Weather & UV data by Open-Meteo.",
  ...
  geolocationUnavailable: "Location is unavailable on this device or browser.",
...
const zh: TranslationMap = {
  ...
  waterResistant: "防水型",
  unsure: "不确定",
  attribution: "天气与 UV 数据来自 Open-Meteo。",
  privacyTitle: "隐私",
  ...
  geolocationUnavailable: "当前设备或浏览器无法获取位置。",
  clearData: "清除本地记录",
